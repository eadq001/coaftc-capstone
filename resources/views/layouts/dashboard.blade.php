...
{{--                    </x-slot:logo>--}}
            ...
            <flux:sidebar.nav class="text-zinc-800 dark:text-zinc-200">
                ...
                <flux:sidebar.item icon="circle-stack" wire:current.exact="bg-green-300!" wire:navigate href="{{ route('dashboard.archived-products') }}" class="text-zinc-800 dark:text-zinc-200 hover:bg-green-300! dark:hover:bg-primary hover:text-white">Backup and Restore</flux:sidebar.item>
                @endif
