...
<style>
    /* Animate the sidebar container */
    flux-sidebar {
        transition: max-width 300ms ease-in-out, width 300ms ease-in-out !important;
    }
    ...
    /* When collapsed - hide content with animation */
    [data-flux-sidebar-collapsed] > div:not(:first-child) {
        opacity: 0;
