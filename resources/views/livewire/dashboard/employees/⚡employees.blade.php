            ...
            <form wire:submit="updateEmployee" class="space-y-5">
                <div class="mb-6 flex items-start justify-between gap-4">
                    <div>
                        ...
                        <flux:text class="mt-1 text-sm text-zinc-500">Click edit to update the selected employee.
                        </flux:text>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    <flux:field>
                        <flux:label>First Name</flux:label>
                        <flux:input type="text" wire:model="first_name" placeholder="First name"
                    ...
                    <flux:field>
                        <flux:label>Last Name</flux:label>
                        <flux:input type="text" wire:model="last_name" placeholder="Last name"
                                    x-bind:readonly="!active"/>
                        <flux:error name="last_name"/>
                    </flux:field>
                    ...
                    <flux:field>
                        <flux:label>Middle Name</flux:label>
                        <flux:input type="text" wire:model="middle_name" placeholder="Middle name"
                                    x-bind:readonly="!active"/>
                        <flux:error name="middle_name"/>
                    </flux:field>
