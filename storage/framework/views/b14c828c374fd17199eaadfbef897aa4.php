...
<?php $component->withAttributes([]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
<?php echo e(ucfirst($name)); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['attributes' => $attributes->whereStartsWith('wire:model'),'type' => ''.e($type).'','name' => ''.e($name).'','value' => ''.e(old($name)).'','placeholder' => ''.e($placeholder).'','autofocus' => true,'autocomplete' => ''.e($autocomplete).'','input:class' => ''.e($inputClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->whereStartsWith('wire:model')),'type' => ''.e($type).'','name' => ''.e($name).'','value' => ''.e(old($name)).'','placeholder' => ''.e($placeholder).'','autofocus' => true,'autocomplete' => ''.e($autocomplete).'','input:class' => ''.e($inputClass).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
<?php /**PATH C:\Herd\coaftcorig\resources\views/components/input.blade.php ENDPATH**/ ?>