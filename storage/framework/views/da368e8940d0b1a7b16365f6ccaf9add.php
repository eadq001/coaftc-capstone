...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Inventory Report Preview <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9)): ?>
<?php $attributes = $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9; ?>
<?php unset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9); ?>
                        ...
                        ?>
                            <table class="min-w-[1180px] w-full border-collapse text-sm mb-3">
                                ...
                                <tr class="transition hover:bg-emerald-50/60">
                                    ...
                                    <td class="px-4 py-4 text-left tabular-nums text-zinc-700"><?php echo e($item->product->stock_level + $item->quantity); ?></td>
                                    <td class="px-4 py-4 text-left tabular-nums text-zinc-700"><?php echo e($item->product->stock_level); ?></td>
                                    <td class="px-4 py-4 text-left tabular-nums text-zinc-700"><?php echo e($item->unit_pricel); ?></td>
                                    <td class="px-4 py-4 text-left font-semibold tabular-nums text-zinc-950"><?php echo e($item->subtotal); ?>
