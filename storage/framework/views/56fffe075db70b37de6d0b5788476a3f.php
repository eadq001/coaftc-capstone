...
<script>
    ...
    const sql = atob('<?php echo e(base64_encode(File::get($path))); ?>');
    const editor = document.querySelector('erd-editor');

    if (checkModuleSupport()) {
        const scripts = [[
            '<?php echo e(asset('vendor/laravel-erd/erd-editor.esm.js')); ?>',
            'https://cdn.jsdelivr.net/npm/@dineug/erd-editor/+esm',
        ], [
            '<?php echo e(asset('vendor/laravel-erd/erd-editor-shiki-worker.esm.js')); ?>',
        ...
        const scripts = [[
            '<?php echo e(asset('vendor/laravel-erd/vuerd.min.js')); ?>',
...
<?php /**PATH C:\Herd\coaftcorig\resources\views/vendor/laravel-erd/erd-editor.blade.php ENDPATH**/ ?>