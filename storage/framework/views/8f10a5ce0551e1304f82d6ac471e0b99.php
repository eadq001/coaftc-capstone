...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['successMessage' => '', 'event' => 'add-edit-product-success']));
...
foreach (array_filter((['successMessage' => '', 'event' => 'add-edit-product-success']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
